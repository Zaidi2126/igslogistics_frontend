        ...
        <div class="collapse navbar-collapse" id="navbar">
            <ul class="navbar-nav ml-auto align-items-center">
                <li class="position-relative">
                    ...
                    <ul class="nav-dropdown">
                        <li><a href="#" class="nav-link">My 1IGS +</a></li>
                        <li><a href="#" class="nav-link">My Supply Chain</a></li>
                        <li><a href="#" class="nav-link">1IGS Same Day</a></li>
                    </ul>
                </li>
                <li>
                    <a href="#" class="nav-link nav-t-link">Sign Up</a>
                </li>
                <li>
