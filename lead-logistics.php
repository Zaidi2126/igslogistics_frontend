...
<div class="section">
    <div class="container industry-1">
        <h2 class="default-heading-2 text-red">Lead Logistics Partner</h2>
...
<div class="section explore">
    <div class="container">
        <h2 class="default-heading-2 text-red">Go Deep on Lead Logistics Partner</h2>
        <p class="mb-3">
    ...
    <div class="container industry-1">
        <div class="row flex-row-reverse align-items-center">
            ...
            <div class="col-lg-6">
                ...
                <h5 class="sub-heading">Questions for an Lead Logistics Partner Expert?</h5>
                <p>
