...
<div class="section">
    <div class="container industry-1">
        <h2 class="default-heading-2 text-red">Services Logistics</h2>
...
<div class="section explore">
    <div class="container">
        <h2 class="default-heading-2 text-red">Go Deep on Services Logistics</h2>
        <p class="mb-3">
    ...
    <div class="container industry-1">
        <div class="row flex-row-reverse align-items-center">
            ...
            <div class="col-lg-6">
                ...
                <h5 class="sub-heading">Questions for an Services Logistics Expert?</h5>
                <p>
